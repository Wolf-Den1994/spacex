var vidbg = (function (e) {
  ...
  function (e, t, r) {
    ...
    e.exports = function (e) {
      ...
      var r = 1;
      8 === (e = e.replace(/^#/, "")).length && ((r = parseInt(e.slice(6, 8), 16) / 255), (e = e.slice(0, 6))),
        4 === e.length && ((r = parseInt(e.slice(3, 4).repeat(2), 16) / 255), (e = e.slice(0, 3))),
      ...
      function e(t, r, n) {
        ...
        if (
          ...
          c(this, "createVideo", function () {
            for (var e in ((l.videoEl = document.createElement("video")), l.videoEl.addEventListener("playing", l.onPlayEvent), l.attributes))
          ...
          c(this, "resize", function () {
            ...
            e / l.videoEl.videoWidth > t / l.videoEl.videoHeight
              ? ((l.videoEl.style.width = "".concat(e, "px")), (l.videoEl.style.height = "auto"))
              : ((l.videoEl.style.width = "auto"), (l.videoEl.style.height = "".concat(t, "px")));
          }),
          !t)
        )
        ...
        this.options = i({}, { mp4: null, webm: null, poster: null, overlay: !1, overlayColor: "#000", overlayAlpha: 0.3 }, r);
        if (((this.attributes = i({}, { controls: !1, loop: !0, muted: !0, playsInline: !0 }, n)), !this.options.mp4 && !this.options.webm))
