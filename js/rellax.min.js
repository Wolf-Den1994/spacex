      ...
      var F,
        B = function () {
          ...
          for (f = 0; f < a.elems.length; f++) {
            ...
            if ((e = /transform\s*:/i.exec(b)))
              (r = b.slice(e.index)), (r = (e = r.indexOf(";")) ? " " + r.slice(11, e).replace(/\s/g, "") : " " + r.slice(11).replace(/\s/g, ""));
            d.push({
              baseX: y.x,
              baseY: y.y,
              top: t,
        ...
        K = function () {
          for (var f, c = 0; c < a.elems.length; c++) {
            ...
            a.elems[c].style[E] =
              "translate3d(" + (a.options.horizontal ? b : "0") + "px," + (a.options.vertical ? e : "0") + "px," + d[c].zindex + "px) " + d[c].transform;
          }
